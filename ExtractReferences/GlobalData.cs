...
namespace ExtractReferences
{
    ...
    {
        public static string ProjectPath = @"D:\DevProjects\AskJoe\Output\";

        public static string[] Solutions
        {
            get
            {
                string projectRoot = ConfigurationManager.AppSettings["root"];
                string allSolutionsAsOneString = ConfigurationManager.AppSettings["Solutions"];
                var allSolutions = allSolutionsAsOneString.Split(',').Select(s => Path.Combine(projectRoot,s));
        ...
        public static string TestData =
                    ...
                    projectReferences('myProject16', 'myProject17')." + Environment.NewLine;
